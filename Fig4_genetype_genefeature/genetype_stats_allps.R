...
filelist<-list.files(path = './realtype05', pattern = '.*\\.csv$', full.names = F)
...
for (file in filelist) {
  ...
  rd<-read.csv(paste0('./realtype05/',file),header=T)
  
  s1<-read.csv(paste0('./shuffletype1_05/',file),header=T)
  s2<-read.csv(paste0('./shuffletype2_05/',file),header=T)
  s3<-read.csv(paste0('./shuffletype3_05/',file),header=T)
...
write.csv(comb_long,'genetype_pval0.05_long.csv',row.names = F)
write.csv(comb_wide,'genetype_pval0.05_wide.csv',row.names = F)
...
comb_wide<-read.csv('genetype_pval0.05_wide.csv',header=T)
...
pdf('genetype_pval0.05_heatmap_unspliceXNM.pdf',width=6.5,height=22)
...
filelist<-list.files(path = './realtype01', pattern = '.*\\.csv$', full.names = F)
...
for (file in filelist) {
  ...
  rd<-read.csv(paste0('./realtype01/',file),header=T)
  
  s1<-read.csv(paste0('./shuffletype1_01/',file),header=T)
  s2<-read.csv(paste0('./shuffletype2_01/',file),header=T)
  s3<-read.csv(paste0('./shuffletype3_01/',file),header=T)
...
write.csv(comb_long,'genetype_pval0.01_long.csv',row.names = F)
write.csv(comb_wide,'genetype_pval0.01_wide.csv',row.names = F)
...
comb_wide<-read.csv('genetype_pval0.01_wide.csv',header=T)
...
pdf('genetype_pval0.01_heatmap_unspliceXNM.pdf',width=6.5,height=22)
draw(ht,heatmap_legend_side = "right",padding = unit(c(30, 30, 30, 30), "mm"))
dev.off()
...
filelist<-list.files(path = './realtype001', pattern = '.*\\.csv$', full.names = F)
...
for (file in filelist) {
  ...
  rd<-read.csv(paste0('./realtype001/',file),header=T)
  
  s1<-read.csv(paste0('./shuffletype1_001/',file),header=T)
  s2<-read.csv(paste0('./shuffletype2_001/',file),header=T)
  s3<-read.csv(paste0('./shuffletype3_001/',file),header=T)
...
write.csv(comb_long,'genetype_pval0.001_long.csv',row.names = F)
write.csv(comb_wide,'genetype_pval0.001_wide.csv',row.names = F)
...
comb_wide<-read.csv('genetype_pval0.001_wide.csv',header=T)
...
int9<-c(list('XISTint9'),rep(list(NA_real_),times=3))
...
pdf('genetype_pval0.001_heatmap_unspliceXNM.pdf',width=6.5,height=22)
draw(ht,heatmap_legend_side = "right",padding = unit(c(30, 30, 30, 30), "mm"))
dev.off()
