...
ck2files<-list.files(path = './k5multicov/', pattern = "^tsc_condE_newpool_unspliced_.*_ck2_multicov\\.out$", full.names = FALSE)
...
ck2data<-read.table(paste0('./k5multicov/',c2file),sep='\t')
