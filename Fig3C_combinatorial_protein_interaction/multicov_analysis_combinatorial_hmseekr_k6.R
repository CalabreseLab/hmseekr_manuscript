...
ck2files<-list.files(path = './k6multicov/', pattern = "^tsc_condE_newpool_unspliced_.*_ck2_multicov\\.out$", full.names = FALSE)
...
ck2data<-read.table(paste0('./k6multicov/',c2file),sep='\t')
