...
do
    ...
    bedtools shuffle -i "./k5bedfiles/tsc_condE_newpool_unspliced_${xnmfilename}_5_viterbi_seekr_hits.bed" -g ../hg38_filtered.fa.fai -excl "./k5bedfiles/tsc_condE_newpool_unspliced_${xnmfilename}_5_viterbi_seekr_hits.bed" -incl ./v47_filtered_ot1fixed_unspliced.bed > "./k5bedfiles/tsc_condE_newpool_unspliced_${xnmfilename}_5_viterbi_seekr_ck2.bed"
    bedtools shuffle -i "./k6bedfiles/tsc_condE_newpool_unspliced_${xnmfilename}_6_viterbi_seekr_hits.bed" -g ../hg38_filtered.fa.fai -excl "./k6bedfiles/tsc_condE_newpool_unspliced_${xnmfilename}_6_viterbi_seekr_hits.bed" -incl ./v47_filtered_ot1fixed_unspliced.bed > "./k6bedfiles/tsc_condE_newpool_unspliced_${xnmfilename}_6_viterbi_seekr_ck2.bed"
