...
for file in XNM/k6bedfiles/tsc_condE_newpool_unspliced*.bed; do
    # Print the current filename
    echo "shuffle: $file"

    base=$(basename "$file" _hits_clean.bed)
    
    bedtools shuffle -i "$file" -g ../hg38_filtered.fa.fai -excl "$file" -incl v47_filtered_ot1fixed_unspliced_clean.bed > "./k6shufflebed1/${base}_shuffle1_clean.bed"

    bedtools shuffle -i "$file" -g ../hg38_filtered.fa.fai -excl "$file" -incl v47_filtered_ot1fixed_unspliced_clean.bed > "./k6shufflebed2/${base}_shuffle2_clean.bed"

    bedtools shuffle -i "$file" -g ../hg38_filtered.fa.fai -excl "$file" -incl v47_filtered_ot1fixed_unspliced_clean.bed > "./k6shufflebed3/${base}_shuffle3_clean.bed"
