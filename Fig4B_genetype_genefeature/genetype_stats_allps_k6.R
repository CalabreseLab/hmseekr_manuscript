...
filelist<-list.files(path = './k6realtype05', pattern = '.*\\.csv$', full.names = F)
...
for (file in filelist) {
  ...
  rd<-read.csv(paste0('./k6realtype05/',file),header=T)
  
  s1<-read.csv(paste0('./k6shuffletype1_05/',file),header=T)
  s2<-read.csv(paste0('./k6shuffletype2_05/',file),header=T)
  s3<-read.csv(paste0('./k6shuffletype3_05/',file),header=T)
...
write.csv(comb_long,'k6genetype_pval0.05_long.csv',row.names = F)
write.csv(comb_wide,'k6genetype_pval0.05_wide.csv',row.names = F)

# adj pval for each gene type across all queries
comb_wide_adj<-data.frame(qchunk=comb_wide$qchunk,
                          unsplice_lncRNA_adjp=p.adjust(comb_wide$unsplice_lncRNA,method = 'BH'),
                          unsplice_other_adjp=p.adjust(comb_wide$unsplice_other,method = 'BH'),
                          unsplice_protein_coding_adjp=p.adjust(comb_wide$unsplice_protein_coding,method = 'BH'))

write.csv(comb_wide_adj,'k6genetype_adjpval0.05_wide.csv',row.names = F)

##################################################plot heatmap#####
# only unsplice ones 0.05
...
comb_wide<-read.csv('k6genetype_adjpval0.05_wide.csv',header=T)
...
comb_wide<-comb_wide[,c("qchunk","lncRNA","protein_coding","other")]
...
pdf('k6genetype_adjpval0.05_heatmap_unspliceXNM.pdf',width=6.5,height=22)
...
filelist<-list.files(path = './k6realtype01', pattern = '.*\\.csv$', full.names = F)
...
for (file in filelist) {
  ...
  rd<-read.csv(paste0('./k6realtype01/',file),header=T)
  
  s1<-read.csv(paste0('./k6shuffletype1_01/',file),header=T)
  s2<-read.csv(paste0('./k6shuffletype2_01/',file),header=T)
  s3<-read.csv(paste0('./k6shuffletype3_01/',file),header=T)
...
write.csv(comb_long,'k6genetype_pval0.01_long.csv',row.names = F)
write.csv(comb_wide,'k6genetype_pval0.01_wide.csv',row.names = F)

# adj pval for each gene type across all queries

comb_wide_adj<-data.frame(qchunk=comb_wide$qchunk,
                          unsplice_lncRNA_adjp=p.adjust(comb_wide$unsplice_lncRNA.bed,method = 'BH'),
                          unsplice_other_adjp=p.adjust(comb_wide$unsplice_other.bed,method = 'BH'),
                          unsplice_protein_coding_adjp=p.adjust(comb_wide$unsplice_protein_coding.bed,method = 'BH'))

write.csv(comb_wide_adj,'k6genetype_adjpval0.01_wide.csv',row.names = F)

##################################################plot heatmap#####
# only unsplice ones 0.01
...
comb_wide<-read.csv('k6genetype_adjpval0.01_wide.csv',header=T)
...
pdf('k6genetype_adjpval0.01_heatmap_unspliceXNM.pdf',width=6.5,height=22)
draw(ht,heatmap_legend_side = "right",padding = unit(c(30, 30, 30, 30), "mm"))
dev.off()
...
filelist<-list.files(path = './k6realtype001', pattern = '.*\\.csv$', full.names = F)
...
for (file in filelist) {
  ...
  rd<-read.csv(paste0('./k6realtype001/',file),header=T)
  
  s1<-read.csv(paste0('./k6shuffletype1_001/',file),header=T)
  s2<-read.csv(paste0('./k6shuffletype2_001/',file),header=T)
  s3<-read.csv(paste0('./k6shuffletype3_001/',file),header=T)
...
write.csv(comb_long,'k6genetype_pval0.001_long.csv',row.names = F)
write.csv(comb_wide,'k6genetype_pval0.001_wide.csv',row.names = F)
...
write.csv(comb_wide_adj,'k6genetype_adjpval0.001_wide.csv',row.names = F)


##################################################plot heatmap#####
# only unsplice ones 0.001
...
comb_wide<-read.csv('k6genetype_adjpval0.001_wide.csv',header=T)
...
pdf('k6genetype_adjpval0.001_heatmap_unspliceXNM.pdf',width=6.5,height=22)
draw(ht,heatmap_legend_side = "right",padding = unit(c(30, 30, 30, 30), "mm"))
dev.off()
