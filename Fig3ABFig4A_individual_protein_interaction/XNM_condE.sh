...
do
  ...
  sbatch -p general --time=24:00:00 -n 8 -N 1 --mem=96g --wrap="hmseekr_findhits_condE -pool './v47_filtered_ot1fixed_unspliced.fa' -m './k5markovModels/${xnmfilename}_v47TSC/5/hmm.dict' -k 5 -name tsc_condE_newpool_unspliced_${xnmfilename} -dir './k5hits/' -a 'ATCG' -fa -pb"

  sbatch -p general --time=24:00:00 -n 8 -N 1 --mem=96g --wrap="hmseekr_findhits_condE -pool './v47_filtered_ot1fixed_unspliced.fa' -m './k6markovModels/${xnmfilename}_v47TSC/6/hmm.dict' -k 6 -name tsc_condE_newpool_unspliced_${xnmfilename} -dir './k6hits/' -a 'ATCG' -fa -pb"
done
