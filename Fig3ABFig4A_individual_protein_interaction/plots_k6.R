...
filelist<-dir(path='./',pattern='XNM_hmseekrhits_paired_unspliced_pval_CKnormed_p.*_k6.csv',full.names = F)
...
for (fname in filelist) {
  ...
  pdf(paste0('XNM_top5RBPs_heatmap_unsplice_',fp,'_k6.pdf'),width=15,height=28)
...
t05<-read.csv('XNM_hmseekrhits_paired_unspliced_pval_CKnormed_p05_k6.csv',header=T)
t01<-read.csv('XNM_hmseekrhits_paired_unspliced_pval_CKnormed_p01_k6.csv',header=T)
t001<-read.csv('XNM_hmseekrhits_paired_unspliced_pval_CKnormed_p001_k6.csv',header=T)
...
pdf('XNM_totalcount_heatmap_unsplice_allps_k6.pdf',width=9,height=28)
...
pdf('XNM_transcript_totalcount_heatmap_unsplice_allps_k6.pdf',width=9,height=28)
draw(xnm,heatmap_legend_side = "right",padding = unit(c(3, 3, 3, 3), "mm"))
dev.off()
