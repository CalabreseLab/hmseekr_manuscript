...
hitfiles<-list.files(path = './k6multicov/', pattern = "^tsc_condE_newpool_unspliced_.*_hits_multicov\\.out$", full.names = FALSE)

ckfiles<-list.files(path = './k6multicov/', pattern = "^tsc_condE_newpool_unspliced_.*_ck_multicov\\.out$", full.names = FALSE)
...
for (n in 1:length(hitfiles)) {
  ...
  filepath <- paste0('./k6multicov/', hfile)
  if (file.info(filepath)$size == 0) {
    print(paste0(hfile,' is empty'))
    
    chunk<-gsub('_6_viterbi_seekr_hits_multicov.out','',hfile)
  ...
  ckdata<-read.table(paste0('./k6multicov/',cfile),sep='\t')
  ...
  combname<-gsub('_6_viterbi_seekr_hits_multicov.out','',hfile)
  
  combname<-paste0('./k6combined/',combname,'_combined_CKnormed_p05.csv')
...
write.csv(hmmstat,'XNM_hmseekrhits_paired_unspliced_pval_CKnormed_p05_k6.csv')
write.csv(hmmcount,'XNM_hmseekrhits_paired_unspliced_ncount_CKnormed_p05_k6.csv')
write.csv(hmmtcount,'XNM_hmseekrhits_paired_unspliced_transcript_count_CKnormed_p05_k6.csv')
write.csv(hmmmedlen,'XNM_hmseekrhits_paired_unspliced_medlen_CKnormed_p05_k6.csv')
...
for (n in 1:length(hitfiles)) {
  ...
  combname<-paste0('./k6combined/',combname,'_combined_CKnormed_p01.csv')
...
write.csv(hmmstat,'XNM_hmseekrhits_paired_unspliced_pval_CKnormed_p01_k6.csv')
write.csv(hmmcount,'XNM_hmseekrhits_paired_unspliced_ncount_CKnormed_p01_k6.csv')
write.csv(hmmtcount,'XNM_hmseekrhits_paired_unspliced_transcript_count_CKnormed_p01_k6.csv')
write.csv(hmmmedlen,'XNM_hmseekrhits_paired_unspliced_medlen_CKnormed_p01_k6.csv')
...
for (n in 1:length(hitfiles)) {
  ...
  combname<-paste0('./k6combined/',combname,'_combined_CKnormed_p001.csv')
...
write.csv(hmmstat,'XNM_hmseekrhits_paired_unspliced_pval_CKnormed_p001_k6.csv')
write.csv(hmmcount,'XNM_hmseekrhits_paired_unspliced_ncount_CKnormed_p001_k6.csv')
write.csv(hmmtcount,'XNM_hmseekrhits_paired_unspliced_transcript_count_CKnormed_p001_k6.csv')
write.csv(hmmmedlen,'XNM_hmseekrhits_paired_unspliced_medlen_CKnormed_p001_k6.csv')
