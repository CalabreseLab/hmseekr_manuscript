...
do
  ...
  sbatch -p general --time=3:00:00 -n 8 -N 1 --mem=96g --wrap="hmseekr_hitseekr -hd './k5hits/tsc_condE_newpool_unspliced_${xnmfilename}_5_viterbi.txt' -qf './fastaFiles/${xnmfilename}.fa' -bkgf './v47.lncRNA.can.500.nodup.OT1fixed.fa' -k 5 -li 0 -la 1000000 -pf 1.1 -rf -1.1 -dir './k5hits/' -pb"

  sbatch -p general --time=3:00:00 -n 8 -N 1 --mem=96g --wrap="hmseekr_hitseekr -hd './k6hits/tsc_condE_newpool_unspliced_${xnmfilename}_6_viterbi.txt' -qf './fastaFiles/${xnmfilename}.fa' -bkgf './v47.lncRNA.can.500.nodup.OT1fixed.fa' -k 6 -li 0 -la 1000000 -pf 1.1 -rf -1.1 -dir './k6hits/' -pb"
