# plot results
setwd("XNM/recovery/k5/wt")
setwd("XNM/recovery/k5/mut10")
setwd("XNM/k5/mut20")
setwd("XNM/k5/mut30")
setwd("XNM/k5/mut40")
setwd("XNM/k5/mut50")
...
write.csv(rand_summary,'XNM_queryrecover_randomization_median_k5.csv',row.names = F)
...
pdf('mean_queryrecover_perct_boxplot_allmuts_k5.pdf',width=13,height=8.5)
plot(p)
dev.off()
...
pdf('mean_queryrecover_count_boxplot_allmuts_k5.pdf',width=13,height=8.5)
plot(p)
dev.off()
