...
filelist05<-dir(path='./k6XIST_05/',pattern='*._wide.csv')

for (n in 1:length(filelist05)) {
  
  temp<-read.csv(paste0('./k6XIST_05/',filelist05[n]),header=T)
...
xrf<-read.csv('./k6XIST_05/XISTrF_raw.csv',header=T)
...
xrb12<-read.csv('./k6XIST_05/XISTrB12_raw.csv',header=T)
...
xrd<-read.csv('./k6XIST_05/XISTrD_raw.csv',header=T)
...
xre<-read.csv('./k6XIST_05/XISTrE_raw.csv',header=T)
...
write.csv(comb_fl,'k6XIST_pattern_matched_p05.csv',row.names = F)
...
#### first get all transcripts that contain hits to all features
filelist05<-dir(path='./k6NEAT1_05/',pattern='*._wide.csv')

for (n in 1:length(filelist05)) {
  
  temp<-read.csv(paste0('./k6NEAT1_05/',filelist05[n]),header=T)
...
write.csv(comb,'k6transcripts_withallNEAT1hits_p05.csv',row.names = F)

sum(grepl('unspliced',comb$seqName)) # 4516

### go through the raw file one by one and check the pattern

n1<-read.csv('./k6NEAT1_05/NEAT1chk1_raw.csv',header=T)
...
n910<-read.csv('./k6NEAT1_05/NEAT1chk910_raw.csv',header=T)
...
n1116<-read.csv('./k6NEAT1_05/NEAT1chk1116_raw.csv',header=T)
...
tuc_n1116<-read.csv('./k6NEAT1_05/NEAT1chk1116_wide.csv',header=T)
...
n22<-read.csv('./k6NEAT1_05/NEAT1chk22_raw.csv',header=T)
...
write.csv(comb_fl,'k6NEAT1_pattern_matched_p05.csv',row.names = F)
...
#### first get all transcripts that contain hits to all features
filelist05<-dir(path='./k6XIST_01/',pattern='*._wide.csv')

for (n in 1:length(filelist05)) {
  
  temp<-read.csv(paste0('./k6XIST_01/',filelist05[n]),header=T)
...
write.csv(comb,'k6transcripts_withallXISThits_p01.csv',row.names = F)

sum(grepl('unspliced',comb$seqName)) # 9 only 1 spliced transcripts

### go through the raw file one by one and check the pattern

xra<-read.csv('./k6XIST_01/XISTrA_raw.csv',header=T)
...
xrf<-read.csv('./k6XIST_01/XISTrF_raw.csv',header=T)
...
xrb12<-read.csv('./k6XIST_01/XISTrB12_raw.csv',header=T)
...
xrd<-read.csv('./k6XIST_01/XISTrD_raw.csv',header=T)
...
xre<-read.csv('./k6XIST_01/XISTrE_raw.csv',header=T)
...
write.csv(comb_fl,'k6XIST_pattern_matched_p01.csv',row.names = F)
...
#### first get all transcripts that contain hits to all features
filelist05<-dir(path='./k6NEAT1_01/',pattern='*._wide.csv')

for (n in 1:length(filelist05)) {
  
  temp<-read.csv(paste0('./k6NEAT1_01/',filelist05[n]),header=T)
...
write.csv(comb,'k6transcripts_withallNEAT1hits_p01.csv',row.names = F)

sum(grepl('unspliced',comb$seqName)) # 1770

### go through the raw file one by one and check the pattern

n1<-read.csv('./k6NEAT1_01/NEAT1chk1_raw.csv',header=T)
...
n910<-read.csv('./k6NEAT1_01/NEAT1chk910_raw.csv',header=T)
...
n1116<-read.csv('./k6NEAT1_01/NEAT1chk1116_raw.csv',header=T)
...
# require the unique coverage > 1kb in n1116
tuc_n1116<-read.csv('./k6NEAT1_01/NEAT1chk1116_wide.csv',header=T)
tuc_n1116<-tuc_n1116[which(tuc_n1116$total_unique_coverage>=1000),]
...
n22<-read.csv('./k6NEAT1_01/NEAT1chk22_raw.csv',header=T)
...
write.csv(comb_fl,'k6NEAT1_pattern_matched_p01.csv',row.names = F)
...
#### first get all transcripts that contain hits to all features
filelist05<-dir(path='./k6XIST_001/',pattern='*._wide.csv')

for (n in 1:length(filelist05)) {
  
  temp<-read.csv(paste0('./k6XIST_001/',filelist05[n]),header=T)
...
write.csv(comb,'k6transcripts_withallXISThits_p001.csv',row.names = F)

sum(grepl('unspliced',comb$seqName)) # 1

### go through the raw file one by one and check the pattern

xra<-read.csv('./k6XIST_001/XISTrA_raw.csv',header=T)
...
xrf<-read.csv('./k6XIST_001/XISTrF_raw.csv',header=T)
...
xrb12<-read.csv('./k6XIST_001/XISTrB12_raw.csv',header=T)
...
xrd<-read.csv('./k6XIST_001/XISTrD_raw.csv',header=T)
...
xre<-read.csv('./k6XIST_001/XISTrE_raw.csv',header=T)
...
write.csv(comb_fl,'k6XIST_pattern_matched_p001.csv',row.names = F)
...
#### first get all transcripts that contain hits to all features
filelist05<-dir(path='./k6NEAT1_001/',pattern='*._wide.csv')

for (n in 1:length(filelist05)) {
  
  temp<-read.csv(paste0('./k6NEAT1_001/',filelist05[n]),header=T)
...
write.csv(comb,'k6transcripts_withallNEAT1hits_p001.csv',row.names = F)

sum(grepl('unspliced',comb$seqName)) # 19

### go through the raw file one by one and check the pattern

n1<-read.csv('./k6NEAT1_001/NEAT1chk1_raw.csv',header=T)
...
n910<-read.csv('./k6NEAT1_001/NEAT1chk910_raw.csv',header=T)
...
n1116<-read.csv('./k6NEAT1_001/NEAT1chk1116_raw.csv',header=T)
...
# require the unique coverage > 1kb in n1116
tuc_n1116<-read.csv('./k6NEAT1_001/NEAT1chk1116_wide.csv',header=T)
tuc_n1116<-tuc_n1116[which(tuc_n1116$total_unique_coverage>=1000),]
...
n22<-read.csv('./k6NEAT1_001/NEAT1chk22_raw.csv',header=T)
...
write.csv(comb_fl,'k6NEAT1_pattern_matched_p001.csv',row.names = F)
...
add_gene_type('k6XIST_pattern_matched_p05.csv',genes)
add_gene_type('k6XIST_pattern_matched_p01.csv',genes)
add_gene_type('k6XIST_pattern_matched_p001.csv',genes)

add_gene_type('k6NEAT1_pattern_matched_p05.csv',genes)
add_gene_type('k6NEAT1_pattern_matched_p01.csv',genes)
add_gene_type('k6NEAT1_pattern_matched_p001.csv',genes)
